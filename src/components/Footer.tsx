...
const Footer = () => {
  return (
    <footer className="bg-gray-800 text-gray-300 body-font py-6">
      <div className="container px-6 mx-auto flex flex-col sm:flex-row items-center justify-between">
        {/* Logo and Title */}
        <a className="flex title-font font-medium items-center text-red-600">
          <svg
